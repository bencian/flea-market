...
ActiveRecord::Schema.define(version: 2019_11_06_122752) do
  ...
  create_table "frontend_configurations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
